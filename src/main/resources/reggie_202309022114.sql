...
CREATE TABLE user (
  ...
  name varchar(50) binary DEFAULT NULL COMMENT '姓名',
  phone varchar(100) binary NOT NULL COMMENT '手机号',
  sex varchar(2) binary DEFAULT NULL COMMENT '性别',
  id_number varchar(18) binary DEFAULT NULL COMMENT '身份证号',
  avatar varchar(500) binary DEFAULT NULL COMMENT '头像',
...
CREATE TABLE shopping_cart (
  id bigint(20) NOT NULL COMMENT '主键',
  name varchar(50) binary DEFAULT NULL COMMENT '名称',
  image varchar(100) binary DEFAULT NULL COMMENT '图片',
  user_id bigint(20) NOT NULL COMMENT '主键',
  dish_id bigint(20) DEFAULT NULL COMMENT '菜品id',
  setmeal_id bigint(20) DEFAULT NULL COMMENT '套餐id',
  dish_flavor varchar(50) binary DEFAULT NULL COMMENT '口味',
...
CREATE TABLE setmeal_dish (
  id bigint(20) NOT NULL COMMENT '主键',
  setmeal_id varchar(32) binary NOT NULL COMMENT '套餐id ',
  dish_id varchar(32) binary NOT NULL COMMENT '菜品id',
  name varchar(32) binary DEFAULT NULL COMMENT '菜品名称 （冗余字段）',
...
CREATE TABLE setmeal (
  ...
  name varchar(64) binary NOT NULL COMMENT '套餐名称',
  price decimal(10, 2) NOT NULL COMMENT '套餐价格',
  status int(11) DEFAULT NULL COMMENT '状态 0:停用 1:启用',
  code varchar(32) binary DEFAULT NULL COMMENT '编码',
  description varchar(512) binary DEFAULT NULL COMMENT '描述信息',
  image varchar(255) binary DEFAULT NULL COMMENT '图片',
  create_time datetime NOT NULL COMMENT '创建时间',
  update_time datetime NOT NULL COMMENT '更新时间',
  create_user bigint(20) NOT NULL COMMENT '创建人',
  update_user bigint(20) NOT NULL COMMENT '修改人',
...
--
-- Create index `idx_setmeal_name` on table `setmeal`
--
ALTER TABLE setmeal
ADD UNIQUE INDEX idx_setmeal_name (name);
...
CREATE TABLE order_detail (
  id bigint(20) NOT NULL COMMENT '主键',
  name varchar(50) binary DEFAULT NULL COMMENT '名字',
  image varchar(100) binary DEFAULT NULL COMMENT '图片',
...
CREATE TABLE orders (
  id bigint(20) NOT NULL COMMENT '主键',
  number varchar(50) binary DEFAULT NULL COMMENT '订单号',
...
CREATE TABLE employee (
  id bigint(20) NOT NULL COMMENT '主键',
  name varchar(32) binary NOT NULL COMMENT '姓名',
  username varchar(32) binary NOT NULL COMMENT '用户名',
  password varchar(64) binary NOT NULL COMMENT '密码',
  phone varchar(11) binary NOT NULL COMMENT '手机号',
  sex varchar(2) binary NOT NULL COMMENT '性别',
  id_number varchar(18) binary NOT NULL COMMENT '身份证号',
...
--
-- Create index `idx_username` on table `employee`
--
...
CREATE TABLE dish_flavor (
  ...
  name varchar(64) binary NOT NULL COMMENT '口味名称',
  value varchar(500) binary DEFAULT NULL COMMENT '口味数据list',
  create_time datetime NOT NULL COMMENT '创建时间',
  update_time datetime NOT NULL COMMENT '更新时间',
  create_user bigint(20) NOT NULL COMMENT '创建人',
  update_user bigint(20) NOT NULL COMMENT '修改人',
...
CREATE TABLE dish (
  id bigint(20) NOT NULL COMMENT '主键',
  name varchar(64) binary NOT NULL COMMENT '菜品名称',
  category_id bigint(20) NOT NULL COMMENT '菜品分类id',
  price decimal(10, 2) DEFAULT NULL COMMENT '菜品价格',
  code varchar(64) binary NOT NULL COMMENT '商品码',
  image varchar(200) binary NOT NULL COMMENT '图片',
  description varchar(400) binary DEFAULT NULL COMMENT '描述信息',
...
--
-- Create index `idx_dish_name` on table `dish`
--
ALTER TABLE dish
ADD UNIQUE INDEX idx_dish_name (name);
...
CREATE TABLE category (
  ...
  name varchar(64) binary NOT NULL COMMENT '分类名称',
  sort int(11) NOT NULL DEFAULT 0 COMMENT '顺序',
  create_time datetime NOT NULL COMMENT '创建时间',
  update_time datetime NOT NULL COMMENT '更新时间',
  create_user bigint(20) NOT NULL COMMENT '创建人',
...
--
-- Create index `idx_category_name` on table `category`
--
ALTER TABLE category
ADD UNIQUE INDEX idx_category_name (name);
...
CREATE TABLE address_book (
  ...
  consignee varchar(50) binary NOT NULL COMMENT '收货人',
...
(1609156826811604993, NULL, '18014000830', NULL, NULL, NULL, 1);

-- 
-- Dumping data for table shopping_cart
--
-- Table reggie.shopping_cart does not contain any data (it is empty)

-- 
-- Dumping data for table setmeal_dish
--
INSERT INTO setmeal_dish VALUES
(1415580119052894209, '1415580119015145474', '1397862198033297410', '老火靓汤', 49800.00, 1, 0, '2021-07-15 15:52:55', '2021-07-15 15:52:55', 1415576781934608386, 1415576781934608386, 0),
(1415580119061282817, '1415580119015145474', '1413342036832100354', '北冰洋', 500.00, 1, 0, '2021-07-15 15:52:55', '2021-07-15 15:52:55', 1415576781934608386, 1415576781934608386, 0),
(1415580119069671426, '1415580119015145474', '1413385247889891330', '米饭', 200.00, 1, 0, '2021-07-15 15:52:55', '2021-07-15 15:52:55', 1415576781934608386, 1415576781934608386, 0);

-- 
-- Dumping data for table setmeal
--
INSERT INTO setmeal VALUES
(1415580119015145474, 1413386191767674881, '儿童套餐A计划', 4000.00, 1, '', '', '61d20592-b37f-4d72-a864-07ad5bb8f3bb.jpg', '2021-07-15 15:52:55', '2021-07-15 15:52:55', 1415576781934608386, 1415576781934608386, 0);

-- 
-- Dumping data for table order_detail
--
-- Table reggie.order_detail does not contain any data (it is empty)

-- 
-- Dumping data for table orders
--
-- Table reggie.orders does not contain any data (it is empty)

-- 
-- Dumping data for table employee
--
INSERT INTO employee VALUES
(1, '管理员', 'admin', 'e10adc3949ba59abbe56e057f20f883e', '13812312312', '1', '110101199001010047', 1, '2021-05-06 17:20:07', '2021-05-10 02:24:09', 1, 1);
...
(1397849739297861633, 1397849739276890114, '忌口', '["不要葱","不要蒜","不要香菜","不要辣"]', '2021-05-27 09:38:43', '2021-05-27 09:38:43', 1, 1, 0),
(1397849739323027458, 1397849739276890114, '辣度', '["不辣","微辣","中辣","重辣"]', '2021-05-27 09:38:43', '2021-05-27 09:38:43', 1, 1, 0),
...
(1397850141015715841, 1397850140982161409, '忌口', '["不要葱","不要蒜","不要香菜","不要辣"]', '2021-05-27 09:40:19', '2021-05-27 09:40:19', 1, 1, 0),
(1397850141040881665, 1397850140982161409, '辣度', '["不辣","微辣","中辣","重辣"]', '2021-05-27 09:40:19', '2021-05-27 09:40:19', 1, 1, 0),
(1397850392120307713, 1397850392090947585, '辣度', '["不辣","微辣","中辣","重辣"]', '2021-05-27 09:41:19', '2021-05-27 09:41:19', 1, 1, 0),
(1397850392137084929, 1397850392090947585, '辣度', '["不辣","微辣","中辣","重辣"]', '2021-05-27 09:41:19', '2021-05-27 09:41:19', 1, 1, 0),
...
(1397850851274960898, 1397850851245600769, '忌口', '["不要蒜","不要香菜","不要辣"]', '2021-05-27 09:43:08', '2021-05-27 09:43:08', 1, 1, 0),
(1397850851283349505, 1397850851245600769, '辣度', '["不辣","微辣","中辣","重辣"]', '2021-05-27 09:43:08', '2021-05-27 09:43:08', 1, 1, 0),
...
(1413389540592263169, 1413384757047271425, '温度', '["常温","冷藏"]', '2023-01-02 03:13:04', '2023-01-02 03:13:04', 1, 1, 0),
...
(1397849739276890114, '辣子鸡', 1397844263642378242, 7800.00, '222222222', 'f966a38e-0780-40be-bb52-5699d13cb3d9.jpg', '来自鲜嫩美味的小鸡，值得一尝', 1, 0, '2021-05-27 09:38:43', '2021-05-27 09:38:43', 1, 1, 0),
(1397850140982161409, '毛氏红烧肉', 1397844263642378242, 6800.00, '123412341234', '0a3b3288-3446-4420-bbff-f263d0c02d8e.jpg', '毛氏红烧肉毛氏红烧肉，确定不来一份？', 1, 0, '2021-05-27 09:40:19', '2021-05-27 09:40:19', 1, 1, 0),
(1397850392090947585, '组庵鱼翅', 1397844263642378242, 4800.00, '123412341234', '740c79ce-af29-41b8-b78d-5f49c96e38c4.jpg', '组庵鱼翅，看图足以表明好吃程度', 1, 0, '2021-05-27 09:41:19', '2021-05-27 09:41:19', 1, 1, 0),
(1397850851245600769, '霸王别姬', 1397844263642378242, 12800.00, '123412341234', '057dd338-e487-4bbc-a74c-0384c44a9ca3.jpg', '还有什么比霸王别姬更美味的呢？', 1, 0, '2021-05-27 09:43:08', '2021-05-27 09:43:08', 1, 1, 0),
(1397851099502260226, '全家福', 1397844263642378242, 11800.00, '23412341234', 'a53a4e6a-3b83-4044-87f9-9d49b30a8fdc.jpg', '别光吃肉啦，来份全家福吧，让你长寿又美味', 1, 0, '2021-05-27 09:44:08', '2021-05-27 09:44:08', 1, 1, 0),
(1397851370462687234, '邵阳猪血丸子', 1397844263642378242, 13800.00, '1246812345678', '2a50628e-7758-4c51-9fbb-d37c61cdacad.jpg', '看，美味不？来嘛来嘛，这才是最爱吖', 1, 0, '2021-05-27 09:45:12', '2021-05-27 09:45:12', 1, 1, 0),
(1397851668262465537, '口味蛇', 1397844263642378242, 16800.00, '1234567812345678', '0f4bd884-dc9c-4cf9-b59e-7d5958fec3dd.jpg', '爬行界的扛把子，东兴-口味蛇，让你欲罢不能', 1, 0, '2021-05-27 09:46:23', '2021-05-27 09:46:23', 1, 1, 0),
(1397852391150759938, '辣子鸡丁', 1397844303408574465, 8800.00, '2346812468', 'ef2b73f2-75d1-4d3a-beea-22da0e1421bd.jpg', '辣子鸡丁，辣子鸡丁，永远的魂', 1, 0, '2021-05-27 09:49:16', '2021-05-27 09:49:16', 1, 1, 0),
(1397853183287013378, '麻辣兔头', 1397844303408574465, 19800.00, '123456787654321', '2a2e9d66-b41d-4645-87bd-95f2cfeed218.jpg', '麻辣兔头的详细制作，麻辣鲜香，色泽红润，回味悠长', 1, 0, '2021-05-27 09:52:24', '2021-05-27 09:52:24', 1, 1, 0),
(1397853709101740034, '蒜泥白肉', 1397844303408574465, 9800.00, '1234321234321', 'd2f61d70-ac85-4529-9b74-6d9a2255c6d7.jpg', '多么的有食欲啊', 1, 0, '2021-05-27 09:54:30', '2021-05-27 09:54:30', 1, 1, 0),
(1397853890262118402, '鱼香肉丝', 1397844303408574465, 3800.00, '1234212321234', '8dcfda14-5712-4d28-82f7-ae905b3c2308.jpg', '鱼香肉丝简直就是我们童年回忆的一道经典菜，上学的时候点个鱼香肉丝盖饭坐在宿舍床上看着肥皂剧，绝了！现在完美复刻一下上学的时候感觉', 1, 0, '2021-05-27 09:55:13', '2021-05-27 09:55:13', 1, 1, 0),
(1397854652581064706, '麻辣水煮鱼', 1397844303408574465, 14800.00, '2345312·345321', '1fdbfbf3-1d86-4b29-a3fc-46345852f2f8.jpg', '鱼片是买的切好的鱼片，放几个虾，增加味道', 1, 0, '2021-05-27 09:58:15', '2021-05-27 09:58:15', 1, 1, 0),
(1397854865672679425, '鱼香炒鸡蛋', 1397844303408574465, 2000.00, '23456431·23456', '0f252364-a561-4e8d-8065-9a6797a6b1d3.jpg', '鱼香菜也是川味的特色。里面没有鱼却鱼香味', 1, 0, '2021-05-27 09:59:06', '2021-05-27 09:59:06', 1, 1, 0),
(1397860242057375745, '脆皮烧鹅', 1397844391040167938, 12800.00, '123456786543213456', 'e476f679-5c15-436b-87fa-8c4e9644bf33.jpeg', '“广东烤鸭美而香，却胜烧鹅说古冈（今新会），燕瘦环肥各佳妙，君休偏重便宜坊”，可见烧鹅与烧鸭在粤菜之中已早负盛名。作为广州最普遍和最受欢迎的烧烤肉食，以它的“色泽金红，皮脆肉嫩，味香可口”的特色，在省城各大街小巷的烧卤店随处可见。', 1, 0, '2021-05-27 10:20:27', '2021-05-27 10:20:27', 1, 1, 0),
...
(1397860792492666881, '烤乳猪', 1397844391040167938, 38800.00, '213456432123456', '2e96a7e3-affb-438e-b7c3-e1430df425c9.jpeg', '广式烧乳猪主料是小乳猪，辅料是蒜，调料是五香粉、芝麻酱、八角粉等，本菜品主要通过将食材放入炭火中烧烤而成。烤乳猪是广州最著名的特色菜，并且是“满汉全席”中的主打菜肴之一。烤乳猪也是许多年来广东人祭祖的祭品之一，是家家都少不了的应节之物，用乳猪祭完先人后，亲戚们再聚餐食用。', 1, 0, '2021-05-27 10:22:39', '2021-05-27 10:22:39', 1, 1, 0),
...
(1397861683434139649, '清蒸河鲜海鲜', 1397844391040167938, 38800.00, '1234567876543213456', '1405081e-f545-42e1-86a2-f7559ae2e276.jpeg', '新鲜的海鲜，清蒸是最好的处理方式。鲜，体会为什么叫海鲜。清蒸是广州最经典的烹饪手法，过去岭南地区由于峻山大岭阻隔，交通不便，经济发展起步慢，自家打的鱼放在锅里煮了就吃，没有太多的讲究，但却发现这清淡的煮法能使鱼的鲜甜跃然舌尖。', 1, 0, '2021-05-27 10:26:11', '2021-05-27 10:26:11', 1, 1, 0),
(1397862198033297410, '老火靓汤', 1397844391040167938, 49800.00, '123456786532455', '583df4b7-a159-4cfc-9543-4f666120b25f.jpeg', '老火靓汤又称广府汤，是广府人传承数千年的食补养生秘方，慢火煲煮的中华老火靓汤，火候足，时间长，既取药补之效，又取入口之甘甜。 广府老火汤种类繁多，可以用各种汤料和烹调方法，烹制出各种不同口味、不同功效的汤来。', 1, 0, '2021-05-27 10:28:14', '2021-05-27 10:28:14', 1, 1, 0),
(1397862477831122945, '上汤焗龙虾', 1397844391040167938, 108800.00, '1234567865432', '5b8d2da3-3744-4bb3-acdc-329056b8259d.jpeg', '上汤焗龙虾是一道色香味俱全的传统名菜，属于粤菜系。此菜以龙虾为主料，配以高汤制成的一道海鲜美食。本品肉质洁白细嫩，味道鲜美，蛋白质含量高，脂肪含量低，营养丰富。是色香味俱全的传统名菜。', 1, 0, '2021-05-27 10:29:20', '2021-05-27 10:29:20', 1, 1, 0),
(1413342036832100354, '北冰洋', 1413341197421846529, 500.00, '', 'c99e0aab-3cb7-4eaa-80fd-f47d4ffea694.png', '', 1, 0, '2021-07-09 11:39:35', '2021-07-09 15:12:18', 1, 1, 0),
(1413384757047271425, '王老吉', 1413341197421846529, 8600.00, '', '00874a5e-0df2-446b-8f69-a30eb7d88ee8.png', '', 1, 0, '2021-07-09 14:29:20', '2023-01-02 03:13:04', 1, 1, 0),
(1413385247889891330, '米饭', 1413384954989060097, 200.00, '', 'ee04a05a-1230-46b6-8ad5-1a95b140fff3.png', '', 1, 0, '2021-07-09 14:31:17', '2021-07-11 16:35:26', 1, 1, 0);
...
(1609867441557504002, 2, '测试', 1, '2023-01-02 03:01:23', '2023-01-02 03:01:23', 1, 1);
